...
//       trailer:"https://www.youtube.com/embed/_b1GKGWJbE8",
//        id:1
//   },
//   {
...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <Button className='HomeMenu' variant="contained" color='inherit' onClick={()=>navigate("/")}>Home</Button>
  ...
  <Route path="/movie" element={<BookPage bookItem={bookItem} setBookItem={setBookItem} />}/>
  <Route path="/book/:bookid" element={<BookDetail  bookItem={bookItem}/>}/>
  <Route path="/price" element={<Price />}/>
 <Route path="/addmovie" element={<AddMovie />}/>
 <Route path="/movie/edit/:bookid" element={<Edit/>}/>
